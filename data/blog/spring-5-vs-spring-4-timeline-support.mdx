---
title: 'Spring 5 vs Spring 6: timeline support'
date: '2022-12-17'
...
There is a lot of spring projects that help developers in building application, and all of them are built upon the Spring Framework project. In order to have an idea about all the spring projects, you can visit this [link](https://spring.io/projects).
